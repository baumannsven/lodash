 ...
 * Build: `lodash modularize modern exports="amd" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
 * Based on Underscore.js 1.7.0 <http://underscorejs.org/LICENSE>
 * Copyright 2009-2015 Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
 * Available under MIT license <https://lodash.com/license>
 */
define(['./array', './chain', './collection', './date', './function', './lang', './number', './object', './string', './utility', './internal/LazyWrapper', './internal/LodashWrapper', './internal/arrayEach', './internal/baseCallback', './internal/baseForOwn', './internal/baseFunctions', './lang/isArray', './lang/isObject', './object/keys', './internal/lazyClone', './internal/lazyReverse', './internal/lazyValue', './chain/lodash', './utility/matches', './utility/mixin', './utility/property', './support', './chain/thru'], function(array, chain, collection, date, func, lang, number, object, string, utility, LazyWrapper, LodashWrapper, arrayEach, baseCallback, baseForOwn, baseFunctions, isArray, isObject, keys, lazyClone, lazyReverse, lazyValue, lodash, matches, mixin, property, support, thru) {
...
mixin = (function(func) {
  ...
  lodash.prototype.toJSON = lodash.prototype.valueOf = lodash.prototype.value = chain.wrapperValue;
